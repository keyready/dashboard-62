...
## Состав команды:
###### - [Кофанов Валентин Сергеевич](https://t.me/v666k0) (Backend-developer)
...
- [ ] [Страница загрузки анкет на сервер](dashboard-62/client/src/pages/UploadFilesPage/ui/UploadFilesPage.tsx)
- [ ] [Страница общего сравнения кандидатов](dashboard-62/client/src/pages/CandidatesPage/ui/CandidatesPage/CandidatesPage.tsx)
...
- [ ] [Страница просмотра участников группы](dashboard-62/client/src/pages/FolderOverviewPage/ui/FolderOverviewPage/FolderOverviewPage.tsx)
- [ ] [Страница просмотра статистики группы](dashboard-62/client/src/pages/AllocationPage/ui/AllocationPage/AllocationPage.tsx)
- [ ] [Страница просмотра всех групп кандидатов](dashboard-62/client/src/pages/GroupingPage/ui/GroupingPage/GroupingPage.tsx)
- [ ] [Страница автоматичекого создания группы](dashboard-62/client/src/pages/CreateCandidatePage/ui/CreateCandidatePage/CreateCandidatePage.tsx)
- [ ] [Страница ручного создания группы](dashboard-62/client/src/pages/ManualGroupingPage/ui/ManualGroupingPage/ManualGroupingPage.tsx)