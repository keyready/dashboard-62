...
1. В директории `client` в терминале выполните команду `npm install`
2. В директории `client` в терминале выполните команду `npm start`
3. В директории `server` в терминале выполните команду `python main.py`
4. После окончания сборки проекта в браузере перейдите по адресу `http://localhost:4567`
