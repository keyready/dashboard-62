        ...
        4112: (e, n, t) => {
            ...
            var E = function () {
                ...
                k = (0, o.memo)(function (e) {
                    ...
                    return (0, a.jsx)(i.p, {
                        onSelect: function (e) {
                            for (var n = 0, t = 0, a = e.files, r = 0; r < a.length; r += 1)
                                (n += a[r].size || 0), (t += 1);
                            c(n), p(t);
                        },
                        headerTemplate: function (e) {
                            ...
                            return (0, a.jsxs)(
                                'div',
                                E(
                                    { className: (0, r.A)(A.uploadHeader, {}, [n]) },
                                    {
                                        children: [
                                            (0, a.jsxs)(
                                                l.U,
                                                E({ gap: '8' }, { children: [s, c, o] }),
                                            ),
                                            (0, a.jsx)('div', {
                        ...
                        P(
                            { reducers: B },
                            {
                                children: (0, a.jsxs)(
                                    c.T,
                                    P(
                                        { className: (0, r.A)(z.UploadFilesPage, {}, [n]) },
                                        {
                                            children: [
                                                (0, a.jsx)(w.V, { title: 'Загрузка резюме' }),
                                                (0, a.jsx)(k, {}),
                                            ],
                                        },
                                    ),
                                ...
                                function () {
                                    l &&
                                        Object.entries(s).forEach(function (e) {
                                            var a = e[0];
                                            n.reducerManager.remove(a),
                                                t({ type: '@DESTROY '.concat(a, ' reducer') });
                                        });
                                }
                            );
                        }, []),
