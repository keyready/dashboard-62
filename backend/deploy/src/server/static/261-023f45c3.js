/*! For license information please see 261-023f45c3.js.LICENSE.txt */
'use strict';
    ...
    [261],
    {
        5261: (t, e, i) => {
            ...
            const S =
                ...
                P = (t) => (t <= 0.0031308 ? 12.92 * t : 1.055 * Math.pow(t, 1 / 2.4) - 0.055),
            ...
            const Ct = (t, e, i, s) =>
                ...
                At = ['push', 'pop', 'shift', 'splice', 'unshift'];
            function Tt(t, e) {
                const i = t._chartjs;
                if (!i) return;
                const s = i.listeners,
            ...
            function Ft(t, e, i) {
                ...
                if (t._sorted) {
                    ...
                    d &&
                        (n = St(
                            Math.min(Ct(r, l, h).lo, i ? s : Ct(e, l, a.getPixelForValue(h)).lo),
                            0,
                            s - 1,
                        )),
                        (o = u
                            ? St(
                                  Math.max(
                                      ...
                                      i ? 0 : Ct(e, l, a.getPixelForValue(c), !0).hi + 1,
                                  ),
                                  n,
                                  s,
                              ) - n
            ...
            const Bt = (t) => 0 === t || 1 === t,
                Wt = (t, e, i) => -Math.pow(2, 10 * (t -= 1)) * Math.sin(((t - e) * nt) / i),
                Nt = (t, e, i) => Math.pow(2, -10 * t) * Math.sin(((t - e) * nt) / i) + 1,
                Ht = {
                    linear: (t) => t,
                    easeInQuad: (t) => t * t,
                    easeOutQuad: (t) => -t * (t - 2),
            ...
            function Yt(t) {
                return jt(t) ? t : new L(t).saturate(0.5).darken(0.1).hexString();
            }
            ...
            function xe(t, e) {
                ...
                t.arc(i + a.topLeft, s + a.topLeft, a.topLeft, 1.5 * st, st, !0),
                    t.lineTo(i, s + o - a.bottomLeft),
                    t.arc(i + a.bottomLeft, s + o - a.bottomLeft, a.bottomLeft, st, lt, !0),
            ...
            const _e = /^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/,
                ye = /^(normal|italic|initial|inherit|unset|(oblique( -?[0-9]?[0-9]deg)?))$/;
            function ve(t, e) {
                const i = ('' + t).match(_e);
            ...
            function Se(t) {
                return we(t, ['topLeft', 'topRight', 'bottomLeft', 'bottomRight']);
            }
            function Pe(t) {
                const e = ke(t);
            ...
            const Fe = (t, e) => (!0 === t ? e : 'string' == typeof t ? J(e, t) : void 0);
            ...
            function Be(t, e, i, s) {
                ...
                return (
                    null !== l &&
                    (void 0 === o || o === i || ((l = We(r, a, o, l, s)), null !== l)) &&
                    Ae(Array.from(r), [''], n, o, () =>
                        (function (t, e, i) {
            ...
            function je(t, e, i, s) {
                ...
                let r, l, h, c;
                for (r = 0, l = s; r < l; ++r)
                    (h = r + i), (c = e[h]), (a[r] = { r: n.parse(J(c, o), h) });
                return a;
            }
            ...
            const ii = (t, e, i) => (t > 0 || e > 0) && (!i || !i.shadowRoot);
            function si(t, e) {
            ...
            function pi({ start: t, end: e, count: i, loop: s, style: n }) {
            ...
            function mi(t, e, i) {
                ...
                const { property: s, start: n, end: o } = i,
                    a = e.length,
                    { compare: r, between: l, normalize: h } = gi(s),
                    {
                        start: c,
                        end: d,
                        loop: u,
                    ...
                    (m = e[t % a]),
                        m.skip ||
                            ...
                            p !== b &&
                                ...
                                null !== _ &&
                                    (!x || 0 === r(o, p) || l(o, b, p)) &&
                                    (g.push(pi({ start: _, end: t, loop: u, count: a, style: f })),
                                    (_ = null)),
                                (i = t),
                                (b = p)));
                return (
                    null !== _ && g.push(pi({ start: _, end: d, loop: u, count: a, style: f })), g
                );
            }
            function bi(t, e) {
                const i = [],
            ...
            function Ci(t, e, i, s = {}) {
                ...
                if (null !== e) {
                    for (a = 0, r = n.length; a < r; ++a) {
                        ...
                        (h = t.values[l]), V(h) && (o || 0 === e || ut(e) === ut(h)) && (e += h);
                    }
                    return e;
                }
            }
            ...
            class Fi {
                ...
                linkScales() {
                    const t = this.chart,
                        ...
                        n = (e.xAxisID = W(i.xAxisID, Ei(t, 'x'))),
                        o = (e.yAxisID = W(i.yAxisID, Ei(t, 'y'))),
                        a = (e.rAxisID = W(i.rAxisID, Ei(t, 'r'))),
                        r = e.indexAxis,
                ...
                _destroy() {
                    const t = this._cachedMeta;
                    this._data && Tt(this._data, this), t._stacked && Ri(t);
                }
                _dataCheck() {
                ...
                buildOrUpdateElements(t) {
                    ...
                    (e._stacked = Oi(e.vScale, e)),
                        e.stack !== i.stack && ((s = !0), Ri(e), (e.stack = i.stack)),
                ...
                parseObjectData(t, e, i, s) {
                    ...
                    for (h = 0, c = s; h < c; ++h)
                        (d = h + i),
                            (u = e[d]),
                            (l[h] = { x: n.parse(J(u, a), d), y: o.parse(J(u, r), d) });
                    return l;
                }
                getParsed(t) {
                ...
                applyStack(t, e, i) {
                    const s = this.chart,
                        ...
                        o = e[t.axis];
                    return Ci(
                        { keys: Di(s, !0), values: e._stacks[t.axis]._visualValues },
                        o,
                        n.index,
                        { mode: i },
                    );
                ...
                updateRangeFromParsed(t, e, i, s) {
                    ...
                    s && a && ((s.values = a), (o = Ci(s, n, this._cachedMeta.index))),
                ...
                getMinMax(t, e) {
                    const i = this._cachedMeta,
                        ...
                        r = ((t, e, i) =>
                            t && !e.hidden && e._stacked && { keys: Di(i, !0), values: null })(
                            e,
                            i,
                            this.chart,
                        ),
            ...
            function ji(t, e, i, s) {
                ...
                return (
                    s
                        ? ((a = i), (t = $i((t = (n = t) === (o = e) ? a : n === a ? o : n), i, e)))
                        : (t = $i(t, e, i)),
                    t
                );
            }
            ...
            class Ui extends Fi {
                ...
                parseObjectData(t, e, i, s) {
                    ...
                    for (d = i, u = i + s; d < u; ++d)
                        (g = e[d]),
                            (f = {}),
                            (f[n.axis] = n.parse(J(g, l), d)),
                            c.push(Bi(J(g, h), f, o, d));
                    return c;
                }
                updateRangeFromParsed(t, e, i, s) {
                    ...
                    for (let u = e; u < e + i; u++) {
                        const e = this.getParsed(u),
                            ...
                            p = {
                                ...
                                base: i.base,
                                enableBorderRadius:
                                    !g || Ni(e._custom) || o === g._top || o === g._bottom,
                                x: l ? i.head : f.center,
                                y: l ? f.center : i.head,
                        ...
                        Hi(p, m, g, o), Yi(p, m, h.ratio), this.updateElement(t[u], u, p, s);
                    }
                }
                _getStacks(t, e) {
            ...
            class Xi extends Fi {
                ...
                parseArrayData(t, e, i, s) {
                    ...
                    for (let t = 0; t < n.length; t++) {
                        const s = e[i + t];
                        n[t]._custom = W(s[2], this.resolveDataElementOptions(t + i).radius);
                    }
                    return n;
                }
                parseObjectData(t, e, i, s) {
                ...
                resolveDataElementOptions(t, e) {
                    ...
                    const n = s.radius;
                    return 'active' !== e && (s.radius = 0), (s.radius += W(i && i._custom, n)), s;
                }
            }
            class qi extends Fi {
                static id = 'doughnut';
                ...
                modes: {
                    index(t, e, i, s) {
                        const n = si(e, t),
                            ...
                            r = i.intersect ? as(t, n, o, s, a) : rs(t, n, o, !1, s, a),
                            l = [];
                        return r.length
                    ...
                    dataset(t, e, i, s) {
                        const n = si(e, t),
                            o = i.axis || 'xy',
                            a = i.includeInvisible || !1;
                        let r = i.intersect ? as(t, n, o, s, a) : rs(t, n, o, !1, s, a);
                        if (r.length > 0) {
                    ...
                    point: (t, e, i, s) =>
                        as(t, si(e, t), i.axis || 'xy', s, i.includeInvisible || !1),
                    nearest(t, e, i, s) {
                        const n = si(e, t),
                            o = i.axis || 'xy',
                            a = i.includeInvisible || !1;
                    ...
                    x: (t, e, i, s) => ls(t, si(e, t), 'x', i.intersect, s),
                    y: (t, e, i, s) => ls(t, si(e, t), 'y', i.intersect, s),
                },
            };
            ...
            function ms(t, e, i, s) {
                ...
                const r = Math.max(0, e.outerWidth - gs(a, t, 'left', 'right')),
                    l = Math.max(0, e.outerHeight - gs(a, t, 'top', 'bottom')),
                    h = r !== t.w,
                    c = l !== t.h;
                return (
                    (t.w = r),
            ...
            function xs(t, e, i, s) {
                ...
                for (o = 0, a = t.length, h = 0; o < a; ++o) {
                    ...
                    const { same: a, other: d } = ms(e, i, r, s);
                    (h |= a && n.length), (c = c || d), l.fullSize || n.push(r);
                }
                return (h && xs(n, e, i, s)) || c;
            }
                ...
                for (const r of t) {
                    ...
                    if (r.horizontal) {
                        ...
                        tt(l.start) && (a = l.start),
                            t.fullSize
                                ? _s(t, n.left, a, i.outerWidth - n.right - n.left, o)
                                : _s(t, e.left + l.placed, a, s, o),
                            (l.start = a),
                            (l.placed += s),
                            (a = t.bottom);
                    } else {
                        ...
                        tt(l.start) && (o = l.start),
                            t.fullSize
                                ? _s(t, o, n.top, a, i.outerHeight - n.bottom - n.top)
                                : _s(t, o, e.top + l.placed, a, s),
                            (l.start = o),
                            (l.placed += s),
                            (o = t.right);
                    }
            ...
            var vs = {
                ...
                update(t, e, i, s) {
                    ...
                    xs(r.fullSize, f, d, g),
                        ...
                        ys(r.leftAndTop, f, d, g),
                        (f.x += f.w),
                        (f.y += f.h),
                        ys(r.rightAndBottom, f, d, g),
                        (t.chartArea = {
                            left: f.left,
                            top: f.top,
                            right: f.left + f.w,
            ...
            function Is(t, e, i) {
                ...
                return (
                    a.observe(n),
                    (function (t, e) {
                        Ls.size || window.addEventListener('resize', Rs), Ls.set(t, e);
                    })(t, o),
                    a
                );
            }
            function zs(t, e, i) {
                i && i.disconnect(),
                    'resize' === e &&
                        (function (t) {
                            Ls.delete(t), Ls.size || window.removeEventListener('resize', Rs);
                        })(t);
            }
            function Fs(t, e, i) {
                const s = t.canvas,
            ...
            class Vs extends Ms {
                ...
                addEventListener(t, e, i) {
                    ...
                    const s = t.$proxies || (t.$proxies = {}),
                        n = { attach: As, detach: Ts, resize: Is }[e] || Fs;
                    s[e] = n(t, e, i);
                }
                removeEventListener(t, e) {
                    const i = t.$proxies || (t.$proxies = {}),
                        s = i[e];
                    s &&
                        (({ attach: zs, detach: zs, resize: zs }[e] || Cs)(t, e, s),
                        (i[e] = void 0));
                }
                getDevicePixelRatio() {
                ...
                getMaximumSize(t, e, i, s) {
                    return (function (t, e, i, s) {
                        const n = Qe(t),
                            o = ei(n, 'margin'),
                            a = Je(n.maxWidth, t, 'clientWidth') || at,
                            r = Je(n.maxHeight, t, 'clientHeight') || at,
                            l = (function (t, e, i) {
                                let s, n;
                                if (void 0 === e || void 0 === i) {
                                    ...
                                    if (o) {
                                        ...
                                        (e = t.width - l.width - r.width),
                                            ...
                                            (s = Je(a.maxWidth, o, 'clientWidth')),
                                            (n = Je(a.maxHeight, o, 'clientHeight'));
                        ...
                        return (
                            ...
                            (h = ni(Math.min(h, a, l.maxWidth))),
                            (c = ni(Math.min(c, r, l.maxHeight))),
                            h && !c && (c = ni(h / 2)),
                            (void 0 !== e || void 0 !== i) &&
                                s &&
                                l.height &&
                                c > l.height &&
                                ((c = l.height), (h = ni(Math.floor(c * s)))),
                            { width: h, height: c }
                        );
                    })(t, e, i, s);
                }
            ...
            class Ks extends Ws {
                ...
                getUserBounds() {
                    ...
                    return (
                        ...
                        { min: B(t, i), max: B(e, s), minDefined: V(t), maxDefined: V(e) }
                    );
                }
                getMinMax(t) {
                    let e,
                        ...
                        o.display &&
                            ...
                            ((this.ticks = (function (t, e) {
                                ...
                                if (a > 0) {
                                    ...
                                    for (
                                        Ns(e, h, c, I(s) ? 0 : r - s, r), t = 0, i = a - 1;
                                        t < i;
                                        t++
                                    )
                                        Ns(e, h, c, o[t], o[t + 1]);
                                    return Ns(e, h, c, l, I(s) ? e.length : l + s), h;
                                }
                                return Ns(e, h, c), h;
                            })(this, this.ticks)),
                            (this._labelSizes = null),
                    ...
                    for (l = 0; l < e; l += r) {
                        if (
                            ...
                            if (z(d))
                                for (h = 0, c = d.length; h < c; ++h)
                                    (x = d[h]),
                                        I(x) || z(x) || ((m = ne(s, g.data, g.gc, m, x)), (b += p));
                ...
                getPixelForDecimal(t) {
                    ...
                    return St(this._alignToPixels ? ae(this.chart, e, 0) : e, -32768, 32767);
                }
                ...
                _computeGridLineItems(t) {
                    ...
                    const C = W(s.ticks.maxTicksLimit, h),
                ...
                drawTitle() {
                    ...
                    'bottom' === e || 'center' === e || F(e)
                        ? ((r += o.bottom), z(i.text) && (r += n.lineHeight * (i.text.length - 1)))
                        : (r += o.top);
                    const {
                        titleX: l,
                        titleY: h,
                        ...
                        if (t.isHorizontal()) {
                            if (((u = zt(s, o, r)), F(i))) {
                                ...
                                f = 'center' === i ? (h.bottom + h.top) / 2 + p - e : Hs(t, i, e);
                            d = r - o;
                        } else {
                            if (F(i)) {
                                const t = Object.keys(i)[0],
                                ...
                                u = 'center' === i ? (h.left + h.right) / 2 - m + e : Hs(t, i, e);
            ...
            class Gs {
                ...
                unregister(t) {
                    const e = this.items,
                        ...
                        s = this.scope;
                    i in e && delete e[i],
                        s && i in se[s] && (delete se[s][i], this.override && delete Jt[i]);
                }
            }
            class Zs {
                constructor() {
                    (this.controllers = new Gs(Fi, 'datasets', !0)),
                        (this.elements = new Gs(Ws, 'elements')),
                        ...
                        return (
                            Object.keys(s).forEach((e) => {
                                ...
                                const r = on(
                                    ...
                                    h = i.scales || {};
                                o[e] = K(Object.create(null), [{ axis: r }, a, h[r], h[l]]);
                            }),
                            t.data.datasets.forEach((i) => {
                                const n = i.type || t.type,
                                    a = i.indexAxis || sn(n, e),
                                    r = (Jt[n] || {}).scales || {};
            ...
            function dn(t, e) {
                let i = hn.get(t);
                return i || ((i = e()), hn.set(t, i), cn.add(i)), i;
            }
            const un = (t, e, i) => {
                const s = J(e, i);
                void 0 !== s && t.add(s);
            ...
            class fn {
                constructor(t) {
                    (this._config = (function (t) {
                        return ((t = t || {}).data = ln(t.data)), rn(t), t;
                    })(t)),
                ...
                getOptionScopes(t, e, i) {
                    ...
                    return (
                        0 === l.length && l.push(Object.create(null)), cn.has(e) && o.set(e, l), l
                    );
                }
                chartOptionScopes() {
                    const { options: t, type: e } = this;
                    return [t, Jt[e] || {}, se.datasets[e] || {}, { type: e }, se, Qt];
                }
                    ...
                    (function (t, e) {
                        ...
                        for (const n of e) {
                            const e = i(n),
                                o = s(n),
                                a = (o || e) && t[n];
                            if ((e && (et(a) || pn(a))) || (o && z(a))) return !0;
                        }
                        return !1;
                    })(o, e) &&
                        ((n.$shared = !1),
                        (r = Te(o, (i = et(i) ? i() : i), this.createResolver(t, i, a))));
            ...
            const pn = (t) =>
                    F(t) && Object.getOwnPropertyNames(t).reduce((e, i) => e || et(t[i]), !1),
                mn = ['top', 'bottom', 'left', 'right', 'chartArea'];
            function bn(t, e) {
            ...
            class Pn {
                ...
                constructor(t, e) {
                    ...
                    (this.platform = new (i.platform || Bs(s))()), this.platform.updateConfig(i);
                    ...
                    (this.id = R()),
                        ...
                        (Mn[this.id] = this),
                        a && r
                            ? (vi.listen(this, 'complete', _n),
                              vi.listen(this, 'progress', yn),
                              this._initialize(),
                ...
                getContext() {
                    return (
                        this.$context || (this.$context = Oe(null, { chart: this, type: 'chart' }))
                    );
                }
                ...
                _stop() {
                    let t, e;
                    for (
                        this.stop(), vi.remove(this), t = 0, e = this.data.datasets.length;
                        t < e;
                        ++t
                    )
            ...
            function On(t, e, i, s, n, o) {
                ...
                if ((t.beginPath(), o)) {
                    ...
                    if ((t.lineTo(i.x, i.y), v > 0)) {
                        const e = Cn(D, O, a, r);
                        t.arc(e.x, e.y, v, b + lt, O + Math.PI);
                    }
                    ...
                    if (
                        ...
                        const e = Cn(P, C, a, r);
                        t.arc(e.x, e.y, y, C + Math.PI, m - lt);
                    }
                    const n = Cn(M, m, a, r);
            ...
            function Rn(t, e, i, s) {
                const { points: n, options: o } = e,
                    { count: a, start: r, loop: l, ilen: h } = En(n, i, s),
                    c = (function (t) {
                        return t.stepped
                            ? fe
            ...
            function In(t, e, i, s) {
                const n = e.points,
                    { count: o, start: a, ilen: r } = En(n, i, s),
            ...
            function jn(t, e, i, s) {
                const n = null === e,
                    o = null === i,
                    a = t && !(n && o) && Nn(t, s);
                return a && (n || Pt(e, a.left, a.right)) && (o || Pt(i, a.top, a.bottom));
            }
            function $n(t, e) {
                            ...
                            const e = Nn(t),
                                ...
                                n = (function (t, e, i) {
                                    const s = t.options.borderWidth,
                                        ...
                                        o = ke(s);
                                    return {
                                        t: Hn(n.top, o.top, 0, i),
                                        r: Hn(n.right, o.right, 0, e),
                                        b: Hn(n.bottom, o.bottom, 0, i),
                                        l: Hn(n.left, o.left, 0, e),
                                    };
                                })(t, i / 2, s / 2),
                                o = (function (t, e, i) {
                                    const { enableBorderRadius: s } = t.getProps([
                                        ...
                                        l = s || F(n);
                                    return {
                                        topLeft: Hn(!l || r.top || r.left, o.topLeft, 0, a),
                                        topRight: Hn(!l || r.top || r.right, o.topRight, 0, a),
                                        bottomLeft: Hn(
                                            !l || r.bottom || r.left,
                                            o.bottomLeft,
                                            0,
            ...
            const qn = [
                ...
                Kn = qn.map((t) => t.replace('rgb(', 'rgba(').replace(')', ', 0.5)'));
            function Gn(t) {
                return qn[t % qn.length];
            }
            function Zn(t) {
            ...
            var Qn = {
                ...
                beforeLayout(t, e, i) {
                    ...
                    if (
                        !i.forceOverride &&
                        (Jn(s) || ((a = n) && (a.borderColor || a.backgroundColor)) || (o && Jn(o)))
                    )
                        return;
                    var a;
                    const r = (function (t) {
                        ...
                        return (i, s) => {
                            ...
                            n instanceof qi
                                ? (e = (function (t, e) {
                                      return (t.backgroundColor = t.data.map(() => Gn(e++))), e;
                                  })(i, e))
                                : n instanceof Gi
                                ? (e = (function (t, e) {
                                ...
                                : n &&
                                  (e = (function (t, e) {
                                      return (
                                          (t.borderColor = Gn(e)), (t.backgroundColor = Zn(e)), ++e
                                      );
                                  })(i, e));
                        };
                    })(t);
                    ...
                    t.data.datasets.forEach((e, n) => {
                        ...
                        let c,
                            { start: d, count: u } = (function (t, e) {
                                ...
                                return (
                                    l && (n = St(Ct(e, o.axis, a).lo, 0, i - 1)),
                                    (s = h ? St(Ct(e, o.axis, r).hi + 1, n, i) - n : i - n),
                                    { start: n, count: s }
                                );
                            })(r, l);
                        if (u <= (i.threshold || 4 * s)) to(e);
                        else {
                            switch (
                                (I(o) &&
                                    ((e._data = l),
            ...
            function so(t, e, i, s) {
                ...
                let n = e[t],
                    o = i[t];
                return (
                    'angle' === t && ((n = wt(n)), (o = wt(o))), { property: t, start: n, end: o }
                );
            }
            function no(t, e, i) {
                for (; e > t; e--) {
            ...
            function ao(t, e) {
                ...
                return (
                    ...
                    i.length
                        ? new Vn({ points: i, options: { tension: 0 }, _loop: s, _fullLoop: s })
                        : null
                );
            }
            function ro(t) {
            ...
            function go(t, e, i) {
                const s = (function (t) {
                        ...
                        return n instanceof fo ? n : ao(n, s);
                    })(e),
            ...
            function mo(t, e) {
                            ...
                            for (const e of h) {
                                ...
                                for (const t of r)
                                    a.push({
                                        source: t,
                                        target: e,
                                        start: { [i]: oo(l, s, 'start', Math.max) },
                                        end: { [i]: oo(l, s, 'end', Math.min) },
                                    });
                            }
                        }
                        return a;
                ...
                for (const { source: e, target: l, start: h, end: c } of r) {
                    const { style: { backgroundColor: r = o } = {} } = e,
                        d = !0 !== s;
                    t.save(), (t.fillStyle = r), bo(t, a, d && so(n, h, c)), t.beginPath();
            ...
            var _o = {
                ...
                afterDatasetsUpdate(t, e, i) {
                    ...
                    for (a = 0; a < s; ++a)
                        (o = t.getDatasetMeta(a)),
                            ...
                            n.push(l);
                    for (a = 0; a < s; ++a)
                        (l = n[a]), l && !1 !== l.fill && (l.fill = lo(n, a, i.propagate));
                },
                beforeDraw(t, e, i) {
                    ...
                    for (let e = n.length - 1; e >= 0; --e) {
                        const i = n[e].$filler;
                        i &&
                            (i.line.updateControlPoints(o, i.axis), s && i.fill && go(t.ctx, i, o));
                    }
                },
                beforeDatasetsDraw(t, e, i) {
                    ...
                    for (let e = s.length - 1; e >= 0; --e) {
                        const i = s[e].$filler;
                        ro(i) && go(t.ctx, i, t.chartArea);
                    }
                },
                beforeDatasetDraw(t, e, i) {
                    const s = e.meta.$filler;
                    ro(s) && 'beforeDatasetDraw' === i.drawTime && go(t.ctx, s, t.chartArea);
                },
            ...
            class vo extends Ws {
                        ...
                        this.legendItems.forEach((t, o) => {
                            const { itemWidth: p, itemHeight: m } = (function (t, e, i, s, n) {
                                const o = (function (t, e, i, s) {
                                    ...
                                    a = (function (t, e, i) {
                                        let s = t;
                                        return 'string' != typeof e.text && (s = Mo(e, i)), s;
                                    })(n, s, e.lineHeight);
                ...
                adjustHitBoxes() {
                    ...
                    if (this.isHorizontal()) {
                        ...
                        let n = 0,
                            a = zt(i, this.top + t + s, this.bottom - this.columnSizes[n].height);
                        for (const r of e)
                            r.col !== n &&
                                ((n = r.col),
                                (a = zt(
                ...
                _draw() {
                    ...
                    this.drawTitle(),
                        ...
                        (s.lineWidth = 0.5),
                        (s.font = l.string);
                    const { boxWidth: f, boxHeight: g, itemHeight: p } = yo(o, c),
                        m = this.isHorizontal(),
                ...
                _getLegendItemAt(t, e) {
                    ...
                    if (Pt(t, this.left, this.right) && Pt(e, this.top, this.bottom))
                        for (n = this.legendHitBoxes, i = 0; i < n.length; ++i)
                            if (
                                ((s = n[i]),
                                Pt(t, s.left, s.left + s.width) && Pt(e, s.top, s.top + s.height))
                            )
            ...
            var wo = {
                ...
                _element: vo,
                start(t, e, i) {
                    const s = (t.legend = new vo({ ctx: t.ctx, options: i, chart: t }));
            ...
            var Do = {
                ...
                start(t, e, i) {
                    ...
                    vs.configure(t, s, i), vs.addBox(t, s), Po.set(t, s);
                },
                stop(t) {
                    vs.removeBox(t, Po.get(t)), Po.delete(t);
                },
                beforeUpdate(t, e, i) {
                    const s = Po.get(t);
                    vs.configure(t, s, i), (s.options = i);
            ...
            function Io(t, e, i, s) {
                const { caretSize: n, caretPadding: o, cornerRadius: a } = t,
                    { xAlign: r, yAlign: l } = i,
                    h = n + o,
                    { topLeft: c, topRight: d, bottomLeft: u, bottomRight: f } = Se(a);
                let g = (function (t, e) {
                    let { x: i, width: s } = t;
            ...
            function Wo(t, e, i, s) {
                ...
                return void 0 === n ? Bo[e].call(i, s) : n;
            }
            class No extends Ws {
                static positioners = Co;
                constructor(t) {
                    super(),
                        (this.opacity = 0),
                        (this._active = []),
                ...
                getTitle(t, e) {
                    const { callbacks: i } = e,
                        s = Wo(i, 'beforeTitle', this, t),
                        n = Wo(i, 'title', this, t),
                        o = Wo(i, 'afterTitle', this, t);
                    let a = [];
                    return (a = Oo(a, Ao(s))), (a = Oo(a, Ao(n))), (a = Oo(a, Ao(o))), a;
                }
                getBeforeBody(t, e) {
                    return Fo(Wo(e.callbacks, 'beforeBody', this, t));
                }
                getBody(t, e) {
                    const { callbacks: i } = e,
                        s = [];
                    return (
                        j(t, (t) => {
                            const e = { before: [], lines: [], after: [] },
                                n = Vo(i, t);
                            Oo(e.before, Ao(Wo(n, 'beforeLabel', this, t))),
                                Oo(e.lines, Wo(n, 'label', this, t)),
                                Oo(e.after, Ao(Wo(n, 'afterLabel', this, t))),
                                s.push(e);
                        }),
                        s
                    );
                ...
                getAfterBody(t, e) {
                    return Fo(Wo(e.callbacks, 'afterBody', this, t));
                }
                getFooter(t, e) {
                    const { callbacks: i } = e,
                        s = Wo(i, 'beforeFooter', this, t),
                        n = Wo(i, 'footer', this, t),
                        o = Wo(i, 'afterFooter', this, t);
                    let a = [];
                    return (a = Oo(a, Ao(s))), (a = Oo(a, Ao(n))), (a = Oo(a, Ao(o))), a;
                }
                _createItems(t) {
                    ...
                    return (
                        ...
                        j(l, (e) => {
                            ...
                            s.push(Wo(i, 'labelColor', this, e)),
                                n.push(Wo(i, 'labelPointStyle', this, e)),
                                o.push(Wo(i, 'labelTextColor', this, e));
                        }),
                        (this.labelColors = s),
                ...
                getCaretPosition(t, e, i) {
                    const { xAlign: s, yAlign: n } = this,
                        ...
                        { topLeft: r, topRight: l, bottomLeft: h, bottomRight: c } = Se(a),
                        { x: d, y: u } = t,
                        { width: f, height: g } = e;
                    let p, m, b, x, _, y;
                    return (
                ...
                _drawColorBox(t, e, i, s, n) {
                    ...
                    if (n.usePointStyle) {
                        ...
                        Object.values(a).some((t) => 0 !== t)
                            ? (t.beginPath(),
                              (t.fillStyle = n.multiKeyBackground),
                              xe(t, { x: e, y: f, w: l, h: r, radius: a }),
                              t.fill(),
                              t.stroke(),
                              (t.fillStyle = o.backgroundColor),
                              t.beginPath(),
                              xe(t, { x: i, y: f + 1, w: l - 2, h: r - 2, radius: a }),
                              t.fill())
                            : ((t.fillStyle = n.multiKeyBackground),
                              t.fillRect(e, f, l, r),
            ...
            var Ho = {
                    ...
                    positioners: Co,
                    afterInit(t, e, i) {
                        i && (t.tooltip = new No({ chart: t, options: i }));
                    },
                    beforeUpdate(t, e, i) {
                    ...
                    const s = (function (t, e) {
                        ...
                        for (
                            ...
                            (d && v !== o
                                ? (i.push({ value: o }),
                                  v < o && P++,
                                  ft(Math.round((v + P * k) * y) / y, o, Uo(o, _, t)) && P++)
                                : v < o && P++);
                            P < w;
                            ++P
                        ) {
                        ...
                        return (
                            b && d && M !== a
                                ? i.length && ft(i[i.length - 1].value, a, Uo(a, _, t))
            ...
            const Ko = (t) => Math.floor(dt(t)),
                Go = (t, e) => Math.pow(10, Ko(t) + e);
            function Zo(t) {
            ...
            class Qo extends Ks {
                ...
                static defaults = {
                    ticks: { callback: Zt.formatters.logarithmic, major: { enabled: !0 } },
                };
                constructor(t) {
                    super(t),
                        (this.start = void 0),
                ...
                determineDataLimits() {
                    ...
                    (this.min = V(t) ? Math.max(0, t) : null),
                        ...
                        this._zero &&
                            ...
                            !V(this._userMin) &&
                            (this.min = t === Go(this.min, 0) ? Go(this.min, -1) : Go(this.min, 0)),
                        this.handleTickRangeOptions();
                }
                handleTickRangeOptions() {
                    const { minDefined: t, maxDefined: e } = this.getUserBounds();
                    ...
                    const n = (e) => (i = t ? i : e),
                        o = (t) => (s = e ? s : t);
                    i === s && (i <= 0 ? (n(1), o(10)) : (n(Go(i, -1)), o(Go(s, 1)))),
                        i <= 0 && n(Go(s, -1)),
                        s <= 0 && o(Go(i, 1)),
                        (this.min = i),
                        (this.max = s);
                    ...
                    const t = this.options,
                        e = (function (t, { min: e, max: i }) {
                            ...
                            let d = Math.floor((h - c) / Math.pow(10, o)),
                                u = B(t.min, Math.round((l + c + d * Math.pow(10, o)) * a) / a);
                            for (; u < i; )
                                s.push({ value: u, major: Zo(u), significand: d }),
                                    d >= 10 ? (d = d < 15 ? 15 : 20) : d++,
                                    d >= 20 && (o++, (d = 2), (a = o >= 0 ? 1 : a)),
                                    (u = Math.round((l + c + d * Math.pow(10, o)) * a) / a);
                            const f = B(t.max, u);
                            return s.push({ value: f, major: Zo(f), significand: d }), s;
            ...
            function oa(t, e, i) {
                ...
                if (!I(r)) {
                    ...
                    Object.values(i).some((t) => 0 !== t)
                        ? (t.beginPath(), xe(t, { x: h, y: c, w: d, h: u, radius: i }), t.fill())
                        : t.fillRect(h, c, d, u);
                }
            }
            function aa(t, e, i, s) {
            ...
            class ra extends Xo {
                ...
                static defaults = {
                    ...
                    grid: { circular: !1 },
                    startAngle: 0,
                    ticks: { showLabelBackdrop: !0, callback: Zt.formatters.numeric },
                    pointLabels: {
                ...
                setDimensions() {
                    const t = (this._padding = Pe(ta(this.options) / 2)),
                        ...
                        ? (function (t) {
                              ...
                              for (let d = 0; d < o; d++) {
                                  ...
                                  const p = wt(t.getIndexAngle(d) + r),
                                      m = Math.round(xt(p));
                                  ia(i, e, p, ea(m, u.x, g.w, 0, 180), ea(m, u.y, g.h, 90, 270));
                              }
                              var l, h, c;
                              t.setCenterPoint(e.l - i.l, i.r - e.r, e.t - i.t, i.b - e.b),
                                  (t._pointLabelItems = (function (t, e, i) {
                                      const s = [],
                                          ...
                                          l = { extra: ta(o) / 2, additionalAngle: a ? st / n : 0 };
                                      let h;
                                      for (let o = 0; o < n; o++) {
                                          ...
                                          s.push(n),
                                              'auto' === r &&
                                                  ((n.visible = na(n, h)), n.visible && (h = n));
                                      }
                                      return s;
                                  })(t, s, n));
                          })(this)
                        ...
                        (e.pointLabels.display &&
                            (function (t, e) {
                                ...
                                for (let n = e - 1; n >= 0; n--) {
                                    ...
                                    be(i, t._pointLabels[n], r, l + a.lineHeight / 2, a, {
                                        color: o.color,
                                        textAlign: h,
                                        textBaseline: 'middle',
                                    });
            ...
            class pa extends Ks {
                ...
                init(t, e = {}) {
                    const i = t.time || (t.time = {}),
                        s = (this._adapter = new ss._date(t.adapters.date));
                    s.init(e),
                ...
                _generate() {
                    ...
                    for (c = u, d = 0; c < i; c = +t.add(c, a, o), d++) fa(h, c, f);
                    return (
                        (c !== i && 'ticks' !== s.bounds && 1 !== d) || fa(h, c, f),
                        Object.keys(h)
                            .sort(ca)
                            .map((t) => +t)
                    );
            ...
            function ma(t, e, i) {
                let s,
                    ...
                    l = t.length - 1;
                i
                    ? (e >= t[r].pos && e <= t[l].pos && ({ lo: r, hi: l } = Ct(t, 'pos', e)),
                      ({ pos: s, time: o } = t[r]),
                      ({ pos: n, time: a } = t[l]))
                    : (e >= t[r].time && e <= t[l].time && ({ lo: r, hi: l } = Ct(t, 'time', e)),
                      ({ time: s, pos: o } = t[r]),
                      ({ time: n, pos: a } = t[l]));
                const h = n - s;
