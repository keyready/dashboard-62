                ...
                r.forwardRef(function (e, t) {
                    var n = e.message,
                            ...
                            if (!1 !== g) {
                                var t = (0, o.qJ)('close'),
                                    ...
                                    u = (0, a.dG)(
                                        ...
                                        D('button', A),
                                        s(S, 'button', pe(pe({}, P), {}, { hostName: e.hostName })),
                                    );
                        ...
                        L = (function () {
                            if (e.message) {
                                var t = (0, a.dG)(
                                        ...
                                        D('icon', A),
                                        s(S, 'icon', pe(pe({}, P), {}, { hostName: e.hostName })),
                                    ),
                                    n = k;
                                if (!k)
                                    switch (d) {
                                ...
                                var o = a.Cz.getJSXIcon(n, pe({}, t), { props: e }),
                                    ...
                                    l = (0, a.dG)(
                                        ...
                                        D('detail', A),
                                        s(S, 'detail', pe(pe({}, P), {}, { hostName: e.hostName })),
                                    );
                                return (
                                    m ||
                                    r.createElement(
                        ...
                        M = (0, a.dG)(
                            ...
                            D('wrapper', A),
                            s(S, 'wrapper', pe(pe({}, P), {}, { hostName: e.hostName })),
                        ),
                        B = (0, a.dG)(
                            {
                                ref: t,
                            ...
                            D('root', A),
                            s(S, 'root', pe(pe({}, P), {}, { hostName: e.hostName })),
                        );
                    return r.createElement('div', B, r.createElement('div', M, L, T));
                }),
            );
            function de(e, t) {
                var n = Object.keys(e);
                ...
                he = r.memo(
                    r.forwardRef(function (e, t) {
                        var n = r.useContext(o.Ou),
                            ...
                            y = se.setMetaData(p);
                        (0, i.e)(se.css.styles, y.isUnstyled, { name: 'messages' });
                        var d = function (e) {
                                e &&
                                    s(function (t) {
                                        return m(t, e, !0);
                ...
                r.forwardRef(function (e, t) {
                    ...
                    var I = r.useRef(null),
                        ...
                        $ = function (e) {
                            if (s.maxFileSize && e.size > s.maxFileSize) {
                                ...
                                return (
                                    'advanced' === s.mode && F.current.show(t),
                        ...
                        W = function (e) {
                            if (((e = e || m) && e.nativeEvent && (e = m), s.customUpload))
                                s.fileLimit && (e.length, Ie('uploadedFileCount')),
                                    s.uploadHandler &&
                                        s.uploadHandler({
                                            files: e,
                    ...
                    return 'advanced' === s.mode
                        ? (function () {
                              var e,
                                  ...
                                  Z =
                                      ...
                                      (w = a.Cz.getJSXIcon(E, Ke({}, b), { props: s })),
                                      (x = (0, a.dG)(
                                          {
                                              'className': (0, a.AK)(
                                                  t,
                              ...
                              if (!s.auto) {
                                  var $ = s.uploadOptions,
                                      ...
                                      fe = a.Cz.getJSXIcon(
                                          ie.icon || r.createElement(c.q, se),
                                          Ke({}, se),
                                          { props: s },
                                      );
                              ...
                              var pe = (0, a.dG)(
                                      {
                                          className: (0, a.AK)(s.headerClassName, N('buttonbar')),
                                          style: s.headerStyle,
                                      },
                                      A('buttonbar'),
                                  ),
                                  ye = r.createElement('div', pe, Z, k, j);
                              if (s.headerTemplate) {
                                  var de = {
                                      className: (0, a.AK)(
                                          'p-fileupload-buttonbar',
                              ...
                              var me = (0, a.dG)(
                                      { id: s.id, className: N('root'), style: s.style },
                                      Re.getOtherProps(s),
                                      A('root'),
                                  ),
                                  ge = (0, a.dG)(
                                      {
                                          'ref': _,
                                          'className': (0, a.AK)(s.contentClassName, N('content')),
                        ...
                        ? ((ie = s.chooseOptions),
                          ...
                          (ue = s.auto ? le : r.createElement('span', ae, L ? m[0].name : le)),
                          (ce = (0, a.dG)(
                          ...
                          (se = ie.icon
                              ? ie.icon
                              : ie.icon || (L && !s.auto)
                              ? !ie.icon && L && !s.auto && r.createElement(C, ce)
                              : r.createElement(u.p, ce)),
                          (fe = a.Cz.getJSXIcon(se, Ke({}, ce), { props: s, hasFiles: L })),
                          (pe = (0, a.dG)(
                              {
                                  ref: I,
                                  type: 'file',
                          ...
                          (de = (0, a.dG)(
                              { className: (0, a.AK)(s.className, N('root')), style: s.style },
                              Re.getOtherProps(s),
                              A('root'),
                          )),
                          (me = (0, a.dG)(
