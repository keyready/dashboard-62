    ...
    return (
        <DynamicModuleLoader reducers={reducers}>
            <Page className={classNames(classes.UploadFilesPage, {}, [className])}>
                <Form onSubmit={submitFilesHandler} encType="multipart/form-data">
                    <h2>Загрузка новых данных о кандидатах</h2>
                    <Form.Group controlId="formFile" className="mb-3">
                        <Form.Label>Выберите архив с анкетами.</Form.Label>
                        <Form.Control
                    ...
                    {isUploadSuccessful && (
                        <Alert variant={hasDuplicates ? 'warning' : 'success'}>
                            {hasDuplicates ? (
                                <p>{hasDuplicates}</p>
                            ) : (
