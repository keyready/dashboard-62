export { ComparisonPageLazy as ComparisonPage } from './ui/ComparisonPage/ComparisonPage.lazy';
...
export { ComparedData, ComparedDataSchema, BarsInfo, RadarInfo } from './model/types/ComparedData';
