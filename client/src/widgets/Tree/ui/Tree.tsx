...
export const Tree = memo((props: TreeProps) => {
    const { setSelectedParams, selectedParams } = props;
        ...
        setNodes([
            {
                ...
                children: [
                    {
                        label:
                            'Кафедра контроля качества и испытания вооружения, военной ' +
                    ...
                    {
                        label:
                            'Кафедра космических аппаратов и средств межорбитальной тра' +
                            'нспортировки',
                        data:
                            'Кафедра космических аппаратов и средств межорбитальной тран' +
                            'спортировки',
                        key: '0-1',
                    },
                    {
                    ...
                    {
                        label:
                            'Кафедра навигационного-баллистического обеспечения примене' +
                            'ния космических средств и теории полета летательных аппаратов',
                        data:
                            'Кафедра навигационного-баллистического обеспечения применен' +
                            'ия космических средств и теории полета летательных аппаратов',
                        key: '0-5',
                    },
                ],
                key: '0',
            },
            {
                ...
                children: [
                    ...
                    {
                        label:
                            'Кафедра бортового электрооборудования и энергетических сис' +
                            'тем летательных аппаратов',
                        data:
                            'Кафедра бортового электрооборудования и энергетических сист' +
                            'ем летательных аппаратов',
                        key: '1-1',
                    },
                    {
                        label:
                            'Кафедра управления организационно-техническими системами к' +
                            'осмического назначения',
                        data:
                            'Кафедра управления организационно-техническими системами ко' +
                            'смического назначения',
                        key: '1-2',
                    },
                    {
                    ...
                    {
                        label:
                            'Кафедра автоматизированных систем подготовки и пуска ракет' +
                            ' космического назначения.\nкафедра математического и программ' +
                            'ного обеспечения.',
                        data:
                            'Кафедра автоматизированных систем подготовки и пуска ракет ' +
                            'космического назначения.\nкафедра математического и программн' +
                            'ого обеспечения.',
                        key: '1-5',
                    },
                ],
            ...
            },
            {
                ...
                children: [
                    ...
                    {
                        label:
                            'Кафедра систем и средств радиоэлектронной борьбы космическ' +
                            'ого назначения',
                        data:
                            'Кафедра систем и средств радиоэлектронной борьбы космическо' +
                            'го назначения',
                        key: '2-4',
                    },
                    {
    ...
    const handleNodeSelect = useCallback(
        (event: TreeSelectEventNodeEvent) => {
            const newNode = event.node.label;
            if (newNode) {
                setSelectedParams([...selectedParams, newNode]);
            }
        },
    ...
    const handleNodeUnselect = useCallback(
        (event: TreeSelectEventNodeEvent) => {
            const newNode = event.node.label;
            if (newNode) {
                setSelectedParams(selectedParams.filter((param) => param !== newNode));
            }
        },
        [selectedParams, setSelectedParams],
    );
